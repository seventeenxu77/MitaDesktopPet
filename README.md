...
- 在人物身上按住鼠标右键拖动，松开右键放下。
- 左键点击头顶会触发摸头反应，点击脸部或身体会触发轻戳反应；约 1.8 秒内连续点三下会变得有点不耐烦。反应结束后自动恢复原来的状态，不打断坐姿。点击聊天界面不会触发人物反应。
- 将人物臀部移到窗口上边缘附近后放下，即可吸附坐下。
- 坐稳约 2 秒后，人物会在约 1 秒内搭好腿，脚掌随后轻轻回摆、减速停稳。膝盖和脚掌朝向屏幕，脚掌微微勾起；保持二郎腿时，会间歇地缓慢摆动小腿，脚掌和脚趾柔和跟随，不会自动恢复普通坐姿。
- 动作过程中可随时右键拖动，重新坐下后会再次触发。
- 站立或坐着时，会偶尔半睁眼、连续尝试打起精神，随后重新闭眼。启动后约 8–14 秒首次出现，此后每次随机休息约 22–38 秒再尝试；无需手动触发。
